...
class Routes extends Component {
	componentDidMount() {
		...
		// Signal rendering complete for prerendering
			...
			<Router>
				<MuiPickersUtilsProvider utils={MomentUtils}>
					<Container>
						<OnRouteChange>
							<Switch>
								<Route exact path="/element-showcase" component={ElementShowcase} />
								...
								<Route exact path="/events/:id/tickets" component={CheckoutSelection} />
								<Route
									exact
